...
function Card({ title, img }) {
    return(
        <button className="max-sm:max-w-32 group w-full relative max-w-52 bg-neutral-700 rounded-md flex flex-col overflow-hidden border-2 dark:border-neutral-500">
