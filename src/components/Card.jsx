...
function Card({ title, img, url }) {
    return(
        <a target='_blank' href={url} className="duration-200 max-sm:max-w-32 group w-full relative max-w-52 bg-neutral-700 rounded-md flex flex-col overflow-hidden border-2 dark:border-neutral-500">
